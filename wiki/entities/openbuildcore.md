...
CLI: `advisor.py what-can-i-build | gaps <project> | inventory | shopping-list`, `machines.py list | can-print`, `validate.py`; `--json` throughout. MCP surface `obc_mcp`: 7 tools, all reads, none editing inventory or machines. 47 stdlib tests. Apache-2.0. Repo: https://github.com/thewriterben/OpenBuildCore (public).
