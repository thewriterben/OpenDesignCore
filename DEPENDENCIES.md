...
|---|---|---|---|
| ModelContextProtocol | `[2.2.0]` | MIT | Inbound MCP surface (ADR-0009). Official SDK; hand-rolling JSON-RPC framing and the tool schema would be a maintenance liability against a moving spec. |
| Microsoft.Extensions.Hosting | `[9.0.9]` | MIT | Host builder the MCP SDK's stdio transport plugs into |
