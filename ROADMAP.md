...
- [x] **Independent verification of a sidecar's numbers**: `verify-artifact` (ADR-0017) — Blender's mesh kernel agrees with PicoGK on run 50 to the hundredth on extents and 0.12 % on volume; recorded as verification 52 (2026-09-07)
